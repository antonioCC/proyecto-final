...
<h3 style="text-align: center;color:brown;">Productos </h3>

<?= Html::a('Añadir productos', '#', [
        'id' => 'activity-index-link',
        'class' => 'btn btn-success',
        'data-toggle' => 'modal',
        'data-target' => '#modal',
        'data-url' => Url::to(['productos/create', 'empresa_id' => $model->id]),
        'data-pjax' => '0',
    ]); ?>
            ...
            [
                ...
                'buttons' => [
                    'view'=>function ($url, $model, $key) {
                        ...
                        'data-toggle' => 'modal',
                        'data-target' => '#modal',
                        'data-url' => Url::to(['productos/view', 'id' => $model->id]),
                        'data-pjax' => '0',
                    ]);
                },
                    ...
                    'update' => function ($url, $model, $key) {
                        ...
                        <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
                            ...
                            'data-toggle' => 'modal',
                            'data-target' => '#modal',
                            'data-url' => Url::to(['productos/update', 'id' => $model->id]),
                            'data-pjax' => '0',
                        ]);
                    },
